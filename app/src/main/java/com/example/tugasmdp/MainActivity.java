    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter= new OrderAdapter(order, new RVClickListener() {
            ...
            public void recyclerViewListClicked(View v, int posisi) {
                ...
                if (order.get(posisi).getJenis().equals("Tea"))rbtea.setChecked(true);
                if (order.get(posisi).getJenis().equals("Coffee"))rbcoffe.setChecked(true);
                if (order.get(posisi).getJenis().equals("Smoothies"))rbsmoothies.setChecked(true);

                cbpearl.setChecked(false);
                cbcoco.setChecked(false);
                cbpudding.setChecked(false);
                cbred.setChecked(false);
                for (String s : order.get(posisi).getToping()) {
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (inputNama.equalsIgnoreCase("")){
                    ...
                    order.add(new Order(jenis.toString(),topping,harga,qty) );
        ...
        btndelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                harga-=order.get(index).getHarga();
